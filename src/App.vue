<template>
	<main :style="definirFond()">
		...
		<nav v-if="!alerte" :class="{'masque': !nav}" :data-html2canvas-ignore="true" tabindex="-1">
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('codeqr')" @keydown.enter="creerPanneau('codeqr')" v-if="modules.includes('codeqr')" :title="$t('codeqr')">
				<span class="icone"><i class="material-icons">qr_code</i></span>
				<span class="titre">{{ $t('codeqr') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('texte')" @keydown.enter="creerPanneau('texte')" v-if="modules.includes('texte')" :title="$t('texte')">
				<span class="icone"><i class="material-icons">title</i></span>
				<span class="titre">{{ $t('texte') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('tableau')" @keydown.enter="creerPanneau('tableau')" v-if="modules.includes('tableau')" :title="$t('tableau')">
				<span class="icone"><i class="material-icons">table_chart</i></span>
				<span class="titre">{{ $t('tableau') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('image')" @keydown.enter="creerPanneau('image')" v-if="modules.includes('image')" :title="$t('image')">
				<span class="icone"><i class="material-icons">insert_photo</i></span>
				<span class="titre">{{ $t('image') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('galerie')" @keydown.enter="creerPanneau('galerie')" v-if="modules.includes('galerie')" :title="$t('galerieImages')">
				<span class="icone"><i class="material-icons">view_carousel</i></span>
				<span class="titre">{{ $t('galerie') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('dessin')" @keydown.enter="creerPanneau('dessin')" v-if="modules.includes('dessin')" :title="$t('dessin')">
				<span class="icone"><i class="material-icons">gesture</i></span>
				<span class="titre">{{ $t('dessin') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('document')" @keydown.enter="creerPanneau('document')" v-if="modules.includes('document')" :title="$t('document')">
				<span class="icone"><i class="material-icons">description</i></span>
				<span class="titre">{{ $t('doc') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('audio')" @keydown.enter="creerPanneau('audio')" v-if="modules.includes('audio')" :title="$t('audio')">
				<span class="icone"><i class="material-icons">volume_up</i></span>
				<span class="titre">{{ $t('audio') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('synthese')" @keydown.enter="creerPanneau('synthese')" v-if="modules.includes('synthese')" :title="$t('syntheseVocale')">
				<span class="icone"><i class="material-icons">record_voice_over</i></span>
				<span class="titre">{{ $t('synthese') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('video')" @keydown.enter="creerPanneau('video')" v-if="modules.includes('video')" :title="$t('video')">
				<span class="icone"><i class="material-icons">movie_creation</i></span>
				<span class="titre">{{ $t('video') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('webcam')" @keydown.enter="creerPanneau('webcam')" v-if="modules.includes('webcam')" :title="$t('webcam')">
				<span class="icone"><i class="material-icons">photo_camera</i></span>
				<span class="titre">{{ $t('webcam') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('lien')" @keydown.enter="creerPanneau('lien')" v-if="modules.includes('lien')" :title="$t('lien')">
				<span class="icone"><i class="material-icons">link</i></span>
				<span class="titre">{{ $t('lien') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('iframe')" @keydown.enter="creerPanneau('iframe')" v-if="modules.includes('iframe')" :title="$t('contenuIntegre')">
				<span class="icone"><i class="material-icons">code</i></span>
				<span class="titre">{{ $t('iframe') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('html')" @keydown.enter="creerPanneau('html')" v-if="modules.includes('html')" :title="$t('html')">
				<span class="icone"><i class="material-icons">html</i></span>
				<span class="titre">{{ $t('html') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('liste')" @keydown.enter="creerPanneau('liste')" v-if="modules.includes('liste')" :title="$t('liste')">
				<span class="icone"><i class="material-icons">checklist</i></span>
				<span class="titre">{{ $t('liste') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('nuage')" @keydown.enter="creerPanneau('nuage')" v-if="modules.includes('nuage')" :title="$t('nuageMots')">
				<span class="icone"><i class="material-icons">cloud</i></span>
				<span class="titre">{{ $t('nuage') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('ordre')" @keydown.enter="creerPanneau('ordre')" v-if="modules.includes('ordre')" :title="$t('remiseOrdre')">
				<span class="icone"><i class="material-icons">sort_by_alpha</i></span>
				<span class="titre">{{ $t('ordre') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('images-sequentielles')" @keydown.enter="creerPanneau('images-sequentielles')" v-if="modules.includes('images-sequentielles')" :title="$t('imagesSequentielles')">
				<span class="icone"><i class="material-icons">category</i></span>
				<span class="titre">{{ $t('ordreImage') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('trous')" @keydown.enter="creerPanneau('trous')" v-if="modules.includes('trous')" :title="$t('texteATrous')">
				<span class="icone"><i class="material-icons">wysiwyg</i></span>
				<span class="titre">{{ $t('trous') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('surlignage')" @keydown.enter="creerPanneau('surlignage')" v-if="modules.includes('surlignage')" :title="$t('surlignage')">
				<span class="icone"><i class="material-icons">hdr_strong</i></span>
				<span class="titre">{{ $t('surlignage') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('pendu')" @keydown.enter="creerPanneau('pendu')" v-if="modules.includes('pendu')" :title="$t('pendu')">
				<span class="icone"><i class="material-icons">spellcheck</i></span>
				<span class="titre">{{ $t('pendu') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('cartes')" @keydown.enter="creerPanneau('cartes')" v-if="modules.includes('cartes')" :title="$t('cartes')">
				<span class="icone"><i class="material-icons">style</i></span>
				<span class="titre">{{ $t('cartes') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('tirage-texte')" @keydown.enter="creerPanneau('tirage-texte')" v-if="modules.includes('tirage-texte')" :title="$t('tirageSortTexte')">
				<span class="icone"><i class="material-icons">shuffle</i></span>
				<span class="titre">{{ $t('tirageTexte') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('tirage-nombre')" @keydown.enter="creerPanneau('tirage-nombre')" v-if="modules.includes('tirage-nombre')" :title="$t('tirageSortNombre')">
				<span class="icone"><i class="material-icons">123</i></span>
				<span class="titre">{{ $t('tirageNombre') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('tirage-image')" @keydown.enter="creerPanneau('tirage-image')" v-if="modules.includes('tirage-image')" :title="$t('tirageSortImage')">
				<span class="icone"><i class="material-icons">collections</i></span>
				<span class="titre">{{ $t('tirageImage') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('tirage-audio')" @keydown.enter="creerPanneau('tirage-audio')" v-if="modules.includes('tirage-audio')" :title="$t('tirageSortAudio')">
				<span class="icone"><i class="material-icons">subscriptions</i></span>
				<span class="titre">{{ $t('tirageAudio') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('roue')" @keydown.enter="creerPanneau('roue')" v-if="modules.includes('roue')" :title="$t('roue')">
				<span class="icone"><i class="material-icons">pending</i></span>
				<span class="titre">{{ $t('roue') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('histoire')" @keydown.enter="creerPanneau('histoire')" v-if="modules.includes('histoire')" :title="$t('histoire')">
				<span class="icone"><i class="material-icons">history_edu</i></span>
				<span class="titre">{{ $t('histoire') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('plateau')" @keydown.enter="creerPanneau('plateau')" v-if="modules.includes('plateau')" :title="$t('plateau')">
				<span class="icone"><i class="material-icons">grid_on</i></span>
				<span class="titre">{{ $t('plateau') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('des')" @keydown.enter="creerPanneau('des')" v-if="modules.includes('des')" :title="$t('des')">
				<span class="icone"><i class="material-icons">casino</i></span>
				<span class="titre">{{ $t('des') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('classement')" @keydown.enter="creerPanneau('classement')" v-if="modules.includes('classement')" :title="$t('classement')">
				<span class="icone"><i class="material-icons">emoji_events</i></span>
				<span class="titre">{{ $t('classement') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('feu')" @keydown.enter="creerPanneau('feu')" v-if="modules.includes('feu')" :title="$t('feuQuadricolore')">
				<span class="icone"><i class="material-icons">traffic</i></span>
				<span class="titre">{{ $t('feu') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('modalites')" @keydown.enter="creerPanneau('modalites')" v-if="modules.includes('modalites')" :class="{'actif': modalites}" :title="$t('modalitesTravail')">
				<span class="icone"><i class="material-icons">group_work</i></span>
				<span class="titre">{{ $t('modalites') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('groupes')" @keydown.enter="creerPanneau('groupes')" v-if="modules.includes('groupes')" :title="$t('groupes')">
				<span class="icone"><i class="material-icons">group</i></span>
				<span class="titre">{{ $t('groupes') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('chrono')" @keydown.enter="creerPanneau('chrono')" v-if="modules.includes('chrono')" :title="$t('chronometre')">
				<span class="icone"><i class="material-icons">timer</i></span>
				<span class="titre">{{ $t('chrono') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('rebours')" @keydown.enter="creerPanneau('rebours')" v-if="modules.includes('rebours')" :title="$t('compteRebours')">
				<span class="icone"><i class="material-icons">hourglass_empty</i></span>
				<span class="titre">{{ $t('rebours') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('horloge-modulable')" @keydown.enter="creerPanneau('horloge-modulable')" v-if="modules.includes('horloge-modulable')" :title="$t('horlogeModulable')">
				<span class="icone"><i class="material-icons">update</i></span>
				<span class="titre">{{ $t('horlogeM') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('horloge')" @keydown.enter="creerPanneau('horloge')" v-if="modules.includes('horloge')" :title="$t('horloge')">
				<span class="icone"><i class="material-icons">query_builder</i></span>
				<span class="titre">{{ $t('horloge') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('calendrier')" @keydown.enter="creerPanneau('calendrier')" v-if="modules.includes('calendrier')" :title="$t('calendrier')">
				<span class="icone"><i class="material-icons">today</i></span>
				<span class="titre">{{ $t('calendrier') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('sonometre')" @keydown.enter="creerPanneau('sonometre')" v-if="modules.includes('sonometre')" :title="$t('sonometre')">
				<span class="icone"><i class="material-icons">hearing</i></span>
				<span class="titre">{{ $t('volume') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="creerPanneau('retroaction')" @keydown.enter="creerPanneau('retroaction')" v-if="modules.includes('retroaction')" :class="{'actif': retroaction}" :title="$t('retroaction')">
				<span class="icone"><i class="material-icons">thumb_up</i></span>
				<span class="titre">{{ $t('retroaction') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="ouvrirModale('grille')" @keydown.enter="ouvrirModale('grille')" v-if="modules.includes('grille') && Object.keys(grille).length === 0" :title="$t('grille')">
				<span class="icone"><i class="material-icons">view_module</i></span>
				<span class="titre">{{ $t('grille') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="reinitialiserGrille" @keydown.enter="reinitialiserGrille" class="actif" v-else-if="modules.includes('grille') && Object.keys(grille).length > 0" :title="$t('grille')">
				<span class="icone"><i class="material-icons">view_module</i></span>
				<span class="titre">{{ $t('grille') }}</span>
			</div>
			...
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="capturer" @keydown.enter="capturer" :title="$t('capturer')">
				<span class="icone"><i class="material-icons">camera</i></span>
				<span class="titre">{{ $t('capture') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="annoter" @keydown.enter="annoter" v-if="!annotation" :title="$t('annoter')">
				<span class="icone"><i class="material-icons">rate_review</i></span>
				<span class="titre">{{ $t('annoter') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="arreterAnnoter" @keydown.enter="arreterAnnoter" class="actif" v-else :title="$t('annoter')">
				<span class="icone"><i class="material-icons">rate_review</i></span>
				<span class="titre">{{ $t('annoter') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="entrerPleinEcran" @keydown.enter="entrerPleinEcran" v-if="!pleinEcran" :title="$t('mettrePleinEcran')">
				<span class="icone"><i class="material-icons">open_in_full</i></span>
				<span class="titre">{{ $t('ecran') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="sortirPleinEcran" @keydown.enter="sortirPleinEcran" v-else :title="$t('sortirPleinEcran')">
				<span class="icone"><i class="material-icons">close_fullscreen</i></span>
				<span class="titre">{{ $t('ecran') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="ouvrirModale('corbeille')" @keydown.enter="ouvrirModale('corbeille')" :title="$t('corbeille')">
				<span class="icone"><i class="material-icons">delete</i></span>
				<span class="titre">{{ $t('corbeille') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="ouvrirMenu" @keydown.enter="ouvrirMenu" :title="$t('options')">
				<span class="icone"><i class="material-icons">settings</i></span>
				<span class="titre">{{ $t('options') }}</span>
			</div>
			<div role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" @click="ouvrirModale('info')" @keydown.enter="ouvrirModale('info')" :title="$t('aPropos')">
				<span class="icone"><i class="material-icons">info</i></span>
				<span class="titre">{{ $t('aPropos') }}</span>
			</div>
		</nav>

		<span class="bouton-capture" role="button" :tabindex="modale === '' && !menu ? 0 : -1" v-if="lectureSeule" @click="capturer" @keydown.enter="capturer" :title="$t('capturer')" :data-html2canvas-ignore="true"><i class="material-icons">camera</i></span>

		<span class="bouton-annotation" role="button" :tabindex="modale === '' && !menu ? 0 : -1" v-if="!annotation && lectureSeule" @click="annoter" @keydown.enter="annoter" :title="$t('annoter')" :data-html2canvas-ignore="true"><i class="material-icons">rate_review</i></span>
		<span class="bouton-annotation vert" role="button" :tabindex="modale === '' && !menu ? 0 : -1" v-else-if="annotation && lectureSeule" @click="arreterAnnoter" @keydown.enter="arreterAnnoter" :title="$t('annoter')" :data-html2canvas-ignore="true"><i class="material-icons">rate_review</i></span>

		<span class="bouton-plein-ecran" role="button" :tabindex="modale === '' && !menu ? 0 : -1" v-if="!pleinEcran && lectureSeule" @click="entrerPleinEcran" @keydown.enter="entrerPleinEcran" :title="$t('mettrePleinEcran')" :data-html2canvas-ignore="true"><i class="material-icons">open_in_full</i></span>
		<span class="bouton-plein-ecran" role="button" :tabindex="modale === '' && !menu ? 0 : -1" v-else-if="pleinEcran && lectureSeule" @click="sortirPleinEcran" @keydown.enter="sortirPleinEcran" :title="$t('sortirPleinEcran')" :data-html2canvas-ignore="true"><i class="material-icons">close_fullscreen</i></span>

		<span class="bouton-export" role="button" :tabindex="modale === '' && !menu ? 0 : -1" v-if="lectureSeule" @click="exporter" @keydown.enter="exporter" :title="$t('exporterEcran')" :data-html2canvas-ignore="true"><i class="material-icons">save</i></span>

		<span class="nav" role="button" :tabindex="modale === '' && !menu ? 0 : -1" v-if="nav && !lectureSeule" @click="nav = false" @keydown.enter="nav = false" :title="$t('masquerOutils')" :data-html2canvas-ignore="true"><i class="material-icons">expand_more</i></span>
		<span class="nav" role="button" :tabindex="modale === '' && !menu ? 0 : -1" v-else-if="!nav && !lectureSeule" @click="nav = true" @keydown.enter="nav = true" :title="$t('afficherOutils')" :data-html2canvas-ignore="true"><i class="material-icons">expand_less</i></span>

		<span class="bouton-cadenas orange" role="button" :tabindex="modale === '' && !menu ? 0 : -1" v-if="lectureSeule" @click="lectureSeule = false" @keydown.enter="lectureSeule = false" :title="$t('deverrouiller')" :data-html2canvas-ignore="true"><i class="material-icons">lock</i></span>
		<span class="bouton-cadenas" role="button" :tabindex="modale === '' && !menu ? 0 : -1" v-else @click="lectureSeule = true" @keydown.enter="lectureSeule = true" :title="$t('verrouiller')" :data-html2canvas-ignore="true"><i class="material-icons">lock_open</i></span>
		...
		<template v-for="panneau in panneauxPage">
			...
			<PHtml :panneau="panneau" :pages="pages" :nav="nav" :export="exportDonnees" :evenementClavier="evenementClavier" @afficher="afficherPanneau" @fermer="fermerPanneau" @export="modifierPanneau" v-else-if="panneau.type === 'html'" :key="'html_' + panneau.id" />
			<PListe :panneau="panneau" :pages="pages" :nav="nav" :export="exportDonnees" :evenementClavier="evenementClavier" @afficher="afficherPanneau" @fermer="fermerPanneau" @export="modifierPanneau" v-else-if="panneau.type === 'liste'" :key="'liste_' + panneau.id" />
			...
			<PTirageNombre :panneau="panneau" :pages="pages" :nav="nav" :export="exportDonnees" :evenementClavier="evenementClavier" @afficher="afficherPanneau" @fermer="fermerPanneau" @export="modifierPanneau" v-else-if="panneau.type === 'tirage-nombre'" :key="'tirage-nombre_' + panneau.id" />
			...
			<PRoue :panneau="panneau" :pages="pages" :nav="nav" :export="exportDonnees" :evenementClavier="evenementClavier" @afficher="afficherPanneau" @fermer="fermerPanneau" @export="modifierPanneau" v-else-if="panneau.type === 'roue'" :key="'roue_' + panneau.id" />
			...
			<PClassement :panneau="panneau" :pages="pages" :nav="nav" :export="exportDonnees" :evenementClavier="evenementClavier" @afficher="afficherPanneau" @fermer="fermerPanneau" @export="modifierPanneau" v-else-if="panneau.type === 'classement'" :key="'classement_' + panneau.id" />
			<PFeu :panneau="panneau" :pages="pages" :nav="nav" :export="exportDonnees" :evenementClavier="evenementClavier" @afficher="afficherPanneau" @fermer="fermerPanneau" @export="modifierPanneau" v-else-if="panneau.type === 'feu'" :key="'feu_' + panneau.id" />
			...
			<PHorlogeModulable :panneau="panneau" :pages="pages" :nav="nav" :export="exportDonnees" :evenementClavier="evenementClavier" @afficher="afficherPanneau" @fermer="fermerPanneau" @export="modifierPanneau" v-else-if="panneau.type === 'horloge-modulable'" :key="'horloge-modulable_' + panneau.id" />
		...
		<MCorbeille :corbeille="corbeille" v-else-if="modale === 'corbeille'" />
		<MParametres v-if="menu" />

		<div id="pages" v-if="pages.length > 1" :data-html2canvas-ignore="true">
			<div>
				<span role="button" :tabindex="nav && !lectureSeule && modale === '' && !menu ? 0 : -1" :class="{'selectionne': page === index}" @click="afficherPage(index)" @keydown.enter="afficherPage(index)" v-for="index in pages.length" :key="'page_' + index" />
			</div>
		</div>

		<audio id="audio-bip" src="./static/audio/bip.mp3" tabindex="-1" preload style="display: none;" v-if="modules.includes('rebours')" />
		<audio id="audio-cartoon" src="./static/audio/cartoon.mp3" tabindex="-1" preload style="display: none;" v-if="modules.includes('rebours')" />
		<audio id="audio-clave" src="./static/audio/clave.mp3" tabindex="-1" preload style="display: none;" v-if="modules.includes('rebours')" />
		<audio id="audio-djembe" src="./static/audio/djembe.mp3" tabindex="-1" preload style="display: none;" v-if="modules.includes('rebours')" />
		<audio id="audio-goutte" src="./static/audio/goutte.mp3" tabindex="-1" preload style="display: none;" v-if="modules.includes('rebours')" />
		<audio id="audio-maraca" src="./static/audio/maraca.mp3" tabindex="-1" preload style="display: none;" v-if="modules.includes('rebours')" />
		<audio id="audio-mbira" src="./static/audio/mbira.mp3" tabindex="-1" preload style="display: none;" v-if="modules.includes('rebours')" />
		<audio id="audio-metronome" src="./static/audio/metronome.mp3" tabindex="-1" preload style="display: none;" v-if="modules.includes('rebours')" />
		<audio id="audio-triangle" src="./static/audio/triangle.mp3" tabindex="-1" preload style="display: none;" v-if="modules.includes('rebours')" />
	</main>
</template>
...
import PHtml from '@/components/html.vue'
import PListe from '@/components/liste.vue'
...
import PClassement from '@/components/classement.vue'
import PFeu from '@/components/feu.vue'
...
import PHorlogeModulable from '@/components/horloge-modulable.vue'
...
import MCorbeille from '@/components/corbeille.vue'
...
export default {
	...
	data () {
		return {
			...
			modules: ['codeqr', 'texte', 'image', 'galerie', 'document', 'audio', 'video', 'lien', 'iframe', 'nuage', 'tirage-texte', 'tirage-image', 'histoire', 'plateau', 'des', 'feu', 'modalites', 'groupes', 'chrono', 'rebours', 'horloge', 'calendrier', 'retroaction', 'grille'],
			panneaux: [],
			panneauxPage: [],
			langue: 'fr',
			pleinEcran: false,
	...
	watch: {
		page: function (page) {
			...
			this.export = { type: 'page', page: page }
			this.exportDonnees = true
			if (this.panneauxPage.length === 0) {
				this.exportTermine = true
			}
		},
		nav: function (nav) {
			if (nav) {
		...
		lectureSeule: function (lectureSeule) {
			...
			if (lectureSeule === true) {
				...
				panneaux.forEach(function (panneau) {
					if (panneau.querySelector('.jsPanel-btn-close')) {
						panneau.setControlStatus('close', 'show')
					}
					if (panneau.querySelector('.jsPanel-btn-send')) {
						panneau.setControlStatus('send', 'show')
					}
				})
				this.nav = true
			}
		},
		panneauAffiche: function (id) {
			const panneaux = document.querySelectorAll('.jsPanel')
			panneaux.forEach(function (panneau) {
		...
		exportTermine: function (valeur) {
			if (valeur === true && this.export.type === 'page') {
				const page = this.export.page
				...
				this.$nextTick(function () {
					...
					setTimeout(function () {
						...
						imagesLoaded('main', { background: true }, function () {
							...
							this.export = {}
							this.exportTermine = false
							this.panneauxExportes = 0
							if (this.panneauxPage.length > 0) {
								document.querySelector('#' + this.panneauxPage[0].id).front()
								this.$nextTick(function () {
									document.querySelector('#' + this.panneauxPage[0].id).focus()
								}.bind(this))
							} else if (this.nav) {
								document.querySelector('nav div').focus()
							} else if (!this.nav && !this.lectureSeule) {
								document.querySelector('span.nav').focus()
							}
						}.bind(this))
					}.bind(this), 150)
				}.bind(this))
			} else if (valeur === true && this.export.type === 'fichier') {
				const fichier = this.export.fichier
				let donnees = {}
				...
				this.panneauxExportes = 0
				this.fermerModale()
			} else if (valeur === true && this.export.type === 'panneau') {
				const id = this.export.id
				const page = this.export.page
				const deplacer = document.querySelector('#modale-panneau #deplacer').checked
				this.$nextTick(function () {
					const panneaux = JSON.parse(JSON.stringify(this.panneaux))
					panneaux.forEach(function (panneau) {
						if (panneau.id === id && deplacer === true) {
							panneau.page = parseInt(page)
						} else if (panneau.id === id && deplacer === false) {
							const copiePanneau = JSON.parse(JSON.stringify(panneau))
							copiePanneau.page = parseInt(page)
							copiePanneau.id = 'panneau_' + (new Date()).getTime()
							panneaux.push(copiePanneau)
						}
					})
					if (document.querySelector('#' + id) && deplacer === true) {
			...
			} else if (valeur === true && this.export.type === 'corbeille') {
				const id = this.export.id
				const module = this.export.module
				let panneaux = JSON.parse(JSON.stringify(this.panneaux))
				let corbeille = JSON.parse(JSON.stringify(this.corbeille))
				let indexPanneau
				panneaux.forEach(function (panneau, index) {
					if (panneau.id === id) {
						corbeille.push(panneau)
				...
				if (panneaux.length === 1 && document.querySelector('#' + panneaux[0].id)) {
					document.querySelector('#' + panneaux[0].id).focus()
				} else if (panneaux.length > 1 && panneaux[indexPanneau] && document.querySelector('#' + panneaux[indexPanneau].id)) {
					document.querySelector('#' + panneaux[indexPanneau].id).focus()
				} else if (panneaux.length > 1 && panneaux[indexPanneau - 1] && document.querySelector('#' + panneaux[indexPanneau - 1].id)) {
					document.querySelector('#' + panneaux[indexPanneau - 1].id).focus()
				} else if (this.nav) {
					document.querySelector('nav div').focus()
				} else if (!this.nav && !this.lectureSeule) {
					document.querySelector('span.nav').focus()
				}
				if (module === 'retroaction') {
					this.retroaction = false
				} else if (module === 'modalites') {
					this.modalites = false
				}
				this.exportDonnees = false
				this.export = {}
	...
	mounted () {
		...
		document.addEventListener('keydown', function (event) {
			if (event.ctrlKey && event.key === 'k') {
			...
			} else if (this.modale === '' && document.querySelector('#conteneur-modale-panneau') && event.key === 'Escape') {
				document.querySelector('#conteneur-modale-panneau').remove()
			} else if (this.modale !== '' && event.key === 'Escape') {
				this.fermerModale()
				...
				if (this.panneauAffiche !== '') {
					const panneauxPage = this.panneaux.filter(function (element) {
						return element.page === this.page
					}.bind(this))
					for (let i = 0; i < panneauxPage.length; i++) {
						if (panneauxPage[i].id === this.panneauAffiche) {
							if (panneauxPage[i + 1] && document.querySelector('#' + panneauxPage[i + 1].id)) {
								document.querySelector('#' + panneauxPage[i + 1].id).front()
								this.$nextTick(function () {
									document.querySelector('#' + panneauxPage[i + 1].id).focus()
								}.bind(this))
								break
							} else if (document.querySelector('#' + panneauxPage[0].id)) {
								document.querySelector('#' + panneauxPage[0].id).front()
								this.$nextTick(function () {
									document.querySelector('#' + panneauxPage[0].id).focus()
								}.bind(this))
								break
							}
						}
				...
				if (this.panneauAffiche !== '') {
					...
					for (let i = 0; i < panneauxPage.length; i++) {
						if (panneauxPage[i].id === this.panneauAffiche) {
							if (this.panneauxPage[i - 1] && document.querySelector('#' + panneauxPage[i - 1].id)) {
								document.querySelector('#' + panneauxPage[i - 1].id).front()
								this.$nextTick(function () {
									document.querySelector('#' + panneauxPage[i - 1].id).focus()
								}.bind(this))
								break
							} else if (document.querySelector('#' + panneauxPage[panneauxPage.length - 1].id)) {
								document.querySelector('#' + panneauxPage[panneauxPage.length - 1].id).front()
								this.$nextTick(function () {
									document.querySelector('#' + panneauxPage[panneauxPage.length - 1].id).focus()
								}.bind(this))
								break
							}
						}
			...
			} else if ((!this.annotation || (this.annotation && this.outilDeplacer)) && event.target.tagName.toLowerCase() !== 'input' && event.target.tagName.toLowerCase() !== 'textarea' && event.target.tagName.toLowerCase() !== 'select' && !event.target.isContentEditable && !event.target.closest('.pell-content') && (event.key === 'ArrowLeft' || event.key === 'ArrowRight' || event.key === 'ArrowUp' || event.key === 'ArrowDown' || event.key === 'm' || event.key === 'f' || event.key === 'e' || event.key === 's' || event.key === 'c' || event.key === '+' || event.key === '-' || (event.key === 'Delete' && !this.lectureSeule) || (event.key === 'Escape' && !this.lectureSeule))) {
				event.preventDefault()
				if (this.panneauAffiche !== '') {
					this.evenementClavier = { event: event, touche: event.key, id: this.panneauAffiche }
				}
			}
		}.bind(this), false)
		...
		document.querySelector('main').addEventListener('drop', function (event) {
			...
			if (event.dataTransfer.files && event.dataTransfer.files.length > 0) {
				for (let i = 0; i < event.dataTransfer.files.length; i++) {
					if (event.dataTransfer.files[i].type === 'application/pdf' || event.dataTransfer.files[i].type.substring(0, 5) === 'image' || event.dataTransfer.files[i].type.substring(0, 5) === 'audio' || event.dataTransfer.files[i].type.substring(0, 5) === 'video') {
						const id = 'panneau_' + (new Date()).getTime() + Math.random().toString(36).replace(/[^a-z]+/g, '').substring(0, 5)
						const largeur = document.body.clientWidth / 2
						const hauteur = (document.body.clientHeight - this.convertirRem(7.5)) / 2
						let type = event.dataTransfer.files[i].type.substring(0, 5)
						...
						if (type === 'image') {
							...
							reader.onloadend = function (e) {
								...
								const panneau = { page: this.page, id: id, type: type, mode: 'lecture', statut: '', dimensions: {}, position: {}, contenu: { audio: fichier, dataURL: dataURL, vitesse: 1 }, w: 40, h: 12, x: largeur - this.convertirRem(20), y: hauteur - this.convertirRem(6) }
								this.panneaux.push(panneau)
								this.panneauxPage.push(panneau)
							}.bind(this)
						} else if (type === 'video') {
							...
							reader.onloadend = function (e) {
								const dataURL = e.target.result
								fichier = window.URL.createObjectURL(event.dataTransfer.files[i])
								const panneau = { page: this.page, id: id, type: type, mode: 'lecture', statut: '', dimensions: {}, position: {}, contenu: { video: fichier, videoId: '', type: event.dataTransfer.files[i].type, dataURL: dataURL, debutMinutes: '', debutSecondes: '', finMinutes: '', finSecondes: '' }, w: 48, h: 31.5, x: largeur - this.convertirRem(24), y: hauteur - this.convertirRem(15.75) }
								this.panneaux.push(panneau)
								this.panneauxPage.push(panneau)
							}.bind(this)
						} else if (type === 'pdf') {
							...
							reader.onloadend = function (e) {
								const dataURL = e.target.result
								fichier = window.URL.createObjectURL(event.dataTransfer.files[i])
								const panneau = { page: this.page, id: id, type: 'document', mode: 'lecture', statut: '', dimensions: {}, position: {}, contenu: { document: fichier, dataURL: dataURL, type: type }, w: 50, h: 35, x: largeur - this.convertirRem(25), y: hauteur - this.convertirRem(17.5) }
								this.panneaux.push(panneau)
								this.panneauxPage.push(panneau)
							}.bind(this)
						}
	...
	methods: {
		definirFond () {
			...
			} else if (this.fond.includes('/img/partition.png')) {
				return { 'background-image': 'url(' + this.fond + ')', 'background-size': 'contain', 'background-repeat': 'repeat' }
		...
		creerPanneau (type) {
			...
			case 'iframe':
				...
				break
			case 'html':
				panneau = { page: this.page, id: id, type: type, mode: '', statut: '', dimensions: {}, position: {}, contenu: '', w: 44, h: 41, x: largeur - this.convertirRem(22), y: hauteur - this.convertirRem(20.5) }
				break
			case 'liste':
				panneau = { page: this.page, id: id, type: type, mode: '', statut: '', dimensions: {}, position: {}, contenu: '', w: 50, h: 32, x: largeur - this.convertirRem(25), y: hauteur - this.convertirRem(16) }
				break
			case 'nuage':
			...
			case 'tirage-texte':
				...
				break
			case 'tirage-nombre':
				panneau = { page: this.page, id: id, type: type, mode: '', statut: '', dimensions: {}, position: {}, contenu: '', w: 46, h: 28, x: largeur - this.convertirRem(23), y: hauteur - this.convertirRem(14) }
				break
			case 'tirage-image':
			...
			case 'tirage-audio':
				...
				break
			case 'roue':
				panneau = { page: this.page, id: id, type: type, mode: '', statut: '', dimensions: {}, position: {}, contenu: '', w: 60, h: 46, x: largeur - this.convertirRem(30), y: hauteur - this.convertirRem(23) }
				break
			case 'histoire':
				panneau = { page: this.page, id: id, type: type, mode: '', statut: '', dimensions: {}, position: {}, contenu: '', w: 40, h: 22, x: largeur - this.convertirRem(20), y: hauteur - this.convertirRem(11) }
				break
			...
			case 'des':
				...
				break
			case 'classement':
				panneau = { page: this.page, id: id, type: type, mode: '', statut: '', dimensions: {}, position: {}, contenu: '', w: 46, h: 45, x: largeur - this.convertirRem(22.5), y: hauteur - this.convertirRem(21) }
				break
			case 'feu':
				panneau = { page: this.page, id: id, type: type, mode: '', statut: '', dimensions: {}, position: {}, contenu: '', w: 28, h: 57, x: largeur - this.convertirRem(14), y: hauteur - this.convertirRem(28.5) }
				break
			case 'modalites':
		...
		modifierPanneau (donnees) {
			...
			this.panneauxExportes++
			if (this.panneauxExportes === this.panneauxPage.length) {
				this.exportTermine = true
			}
		},
		afficherPanneau (id) {
		...
		fermerPanneau (id, module) {
			this.export = { type: 'corbeille', id: id, module: module }
			this.exportDonnees = true
			this.chargementPage = true
			if (this.panneauxPage.length === 0) {
				this.exportTermine = true
		...
		exporter () {
			...
			this.export = { type: 'fichier', fichier: fichier }
			this.exportDonnees = true
			this.chargementPage = true
			if (this.panneauxPage.length === 0) {
				this.exportTermine = true
