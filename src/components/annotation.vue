<template>
	<TransitionGroup name="fondu">
		...
		<div id="outils-annotation" key="outils">
			<span class="outil historique" role="button" tabindex="0" :title="$t('defaire')" @click="defaire" @keydown.enter="defaire">
				<img src="@/assets/img/defaire.png" :alt="$t('defaire')">
			</span>
			<span class="outil historique" role="button" tabindex="0" :title="$t('refaire')" @click="refaire" @keydown.enter="refaire">
				<img src="@/assets/img/refaire.png" :alt="$t('refaire')">
			</span>
			<span class="separateur" />
			<span class="outil" role="button" tabindex="0" :title="$t('selectionner')" :class="{'actif': outilSelectionner}" @click="definirOutilPrincipal('selectionner')" @keydown.enter="definirOutilPrincipal('selectionner')">
				<img src="@/assets/img/curseur.png" :alt="$t('selectionner')">
			</span>
			<span class="outil" role="button" tabindex="0" :title="$t('dessiner')" :class="{'actif': outilDessiner}" @click="definirOutilPrincipal('dessiner')" @keydown.enter="definirOutilPrincipal('dessiner')">
				<img src="@/assets/img/stylo.png" :alt="$t('dessiner')">
			</span>
			<span class="outil" role="button" tabindex="0" :title="$t('deplacerPanneaux')" :class="{'actif': outilDeplacer}" @click="definirOutilPrincipal('deplacer')" @keydown.enter="definirOutilPrincipal('deplacer')">
				<img src="@/assets/img/pan.png" :alt="$t('deplacerPanneaux')">
			</span>
			<span class="separateur" />
			<span id="outil-rectangle" class="outil" role="button" tabindex="0" :title="$t('rectangle')" :class="{'actif': outilSelectionner && outil === 'rectangle'}" @click="selectionnerOutil('rectangle')" @keydown.enter="selectionnerOutil('rectangle')">
				<img src="@/assets/img/rectangle.png" :alt="$t('rectangle')">
			</span>
			<span id="outil-rectangle-plein" class="outil" role="button" tabindex="0" :title="$t('rectanglePlein')" :class="{'actif': outilSelectionner && outil === 'rectangle-plein'}" @click="selectionnerOutil('rectangle-plein')" @keydown.enter="selectionnerOutil('rectangle-plein')">
				<img src="@/assets/img/rectangle-plein.png" :alt="$t('rectanglePlein')">
			</span>
			<span id="outil-cercle" class="outil" role="button" tabindex="0" :title="$t('cercle')" :class="{'actif': outilSelectionner && outil === 'cercle'}" @click="selectionnerOutil('cercle')" @keydown.enter="selectionnerOutil('cercle')">
				<img src="@/assets/img/cercle.png" :alt="$t('cercle')">
			</span>
			<span id="outil-cercle-plein" class="outil" role="button" tabindex="0" :title="$t('cerclePlein')" :class="{'actif': outilSelectionner && outil === 'cercle-plein'}" @click="selectionnerOutil('cercle-plein')" @keydown.enter="selectionnerOutil('cercle-plein')">
				<img src="@/assets/img/cercle-plein.png" :alt="$t('cerclePlein')">
			</span>
			<span id="outil-etoile" class="outil" role="button" tabindex="0" :title="$t('etoile')" :class="{'actif': outilSelectionner && outil === 'etoile'}" @click="selectionnerOutil('etoile')" @keydown.enter="selectionnerOutil('etoile')">
				<img src="@/assets/img/etoile.png" :alt="$t('etoile')">
			</span>
			<span id="outil-surlignage" class="outil" role="button" tabindex="0" :title="$t('surlignage')" :class="{'actif': outilSelectionner && outil === 'surlignage'}" @click="selectionnerOutil('surlignage')" @keydown.enter="selectionnerOutil('surlignage')">
				<img src="@/assets/img/surligneur.png" :alt="$t('surlignage')">
			</span>
			<span id="outil-ligne" class="outil" role="button" tabindex="0" :title="$t('ligne')" :class="{'actif': outilSelectionner && outil === 'ligne'}" @click="selectionnerOutil('ligne')" @keydown.enter="selectionnerOutil('ligne')">
				<img src="@/assets/img/ligne.png" :alt="$t('ligne')">
			</span>
			<span id="outil-fleche" class="outil" role="button" tabindex="0" :title="$t('fleche')" :class="{'actif': outilSelectionner && outil === 'fleche'}" @click="selectionnerOutil('fleche')" @keydown.enter="selectionnerOutil('fleche')">
				<img src="@/assets/img/fleche.png" :alt="$t('fleche')">
			</span>
			<span id="outil-texte" class="outil" role="button" tabindex="0" :title="$t('texte')" :class="{'actif': outilSelectionner && outil === 'texte'}" @click="selectionnerOutil('texte')" @keydown.enter="selectionnerOutil('texte')">
				<img src="@/assets/img/texte.png" :alt="$t('texte')">
			</span>
			<span id="outil-label" class="outil" role="button" tabindex="0" :title="$t('label')" :class="{'actif': outilSelectionner && outil === 'label'}" @click="selectionnerOutil('label')" @keydown.enter="selectionnerOutil('label')">
				<img src="@/assets/img/label.png" :alt="$t('label')">
			</span>
			<span class="separateur" />
			<span class="outil" role="button" tabindex="0" :title="$t('reinitialiser')" @click="afficherReinitialiser" @keydown.enter="afficherReinitialiser">
				<img src="@/assets/img/reinitialiser.png" :alt="$t('reinitialiser')">
			</span>
			<span class="outil" role="button" tabindex="0" :title="$t('fermer')" @click="$emit('fermer')" @keydown.enter="$emit('fermer')">
				<img src="@/assets/img/fermer.png" :alt="$t('fermer')">
			</span>
		</div>

		<div id="options" v-if="nom !== '' || (!outilSelectionner && !outilDeplacer)" key="options">
			<span class="option icone" role="button" tabindex="0" :title="$t('verrouiller')" @click="verrouiller" @keydown.enter="verrouiller" v-if="outilSelectionner && !objetVerrouille">
				<span><i class="material-icons">lock</i></span>
			</span>
			<span class="option icone orange" role="button" tabindex="0" :title="$t('deverrouiller')" @click="deverrouiller" @keydown.enter="deverrouiller" v-else-if="outilSelectionner && objetVerrouille">
				<span><i class="material-icons">lock_open</i></span>
			</span>
			<span class="option icone" role="button" tabindex="0" :title="$t('mettreDevant')" @click="mettreDevant" @keydown.enter="mettreDevant" v-if="outilSelectionner && objet !== 'selection'">
				<span><i class="material-icons">flip_to_front</i></span>
			</span>
			<span class="option icone" role="button" tabindex="0" :title="$t('mettreDerriere')" @click="mettreDerriere" @keydown.enter="mettreDerriere" v-if="outilSelectionner && objet !== 'selection'">
				<span><i class="material-icons">flip_to_back</i></span>
			</span>
			<span class="separateur" v-if="outilSelectionner" />
			<span class="option noir" role="button" tabindex="0" :class="{'actif': outilDessiner && couleurStylo === '#000000'}" :title="$t('noir')" @click="modifierCouleur('#000000')" @keydown.enter="modifierCouleur('#000000')" v-if="nom !== 'selection' && objet !== 'label'">
				<span class="couleur noir" />
			</span>
			<span class="option blanc" role="button" tabindex="0" :class="{'actif': outilDessiner && couleurStylo === '#ffffff'}" :title="$t('blanc')" @click="modifierCouleur('#ffffff')" @keydown.enter="modifierCouleur('#ffffff')" v-if="nom !== 'selection' && objet !== 'label'">
				<span class="couleur blanc" />
			</span>
			<span class="option rouge" role="button" tabindex="0" :class="{'actif': outilDessiner && couleurStylo === '#ff0000'}" :title="$t('rouge')" @click="modifierCouleur('#ff0000')" @keydown.enter="modifierCouleur('#ff0000')" v-if="nom !== 'selection'">
				<span class="couleur rouge" />
			</span>
			<span class="option jaune" role="button" tabindex="0" :class="{'actif': outilDessiner && couleurStylo === '#ffff00'}" :title="$t('jaune')" @click="modifierCouleur('#ffff00')" @keydown.enter="modifierCouleur('#ffff00')" v-if="nom !== 'selection'">
				<span class="couleur jaune" />
			</span>
			<span class="option vert" role="button" tabindex="0" :class="{'actif': outilDessiner && couleurStylo === '#00ff00'}" :title="$t('vert')" @click="modifierCouleur('#00ff00')" @keydown.enter="modifierCouleur('#00ff00')" v-if="nom !== 'selection'">
				<span class="couleur vert" />
			</span>
			<span class="option bleu" role="button" tabindex="0" :class="{'actif': outilDessiner && couleurStylo === '#04fdff'}" :title="$t('bleu')" @click="modifierCouleur('#04fdff')" @keydown.enter="modifierCouleur('#04fdff')" v-if="nom !== 'selection'">
				<span class="couleur bleu" />
			</span>
			<span class="option icone" role="button" tabindex="0" v-if="nom !== 'selection'" @click="definirCouleur" @keydown.enter="activerInput('couleur-annotation')">
				<label for="couleur-annotation"><i class="material-icons">colorize</i></label>
				<input id="couleur-annotation" type="color" tabindex="0" :value="couleurSelecteur" :title="$t('selectionnerCouleur')">
			</span>
			...
			<span class="option epaisseur" role="button" tabindex="0" :class="{'actif': epaisseurStylo === 2}" @click="modifierEpaisseur(2)" @keydown.enter="modifierEpaisseur(2)" v-if="outilDessiner">
				<span>2</span>
			</span>
			<span class="option epaisseur" role="button" tabindex="0" :class="{'actif': epaisseurStylo === 5}" @click="modifierEpaisseur(5)" @keydown.enter="modifierEpaisseur(5)" v-if="outilDessiner">
				<span>5</span>
			</span>
			<span class="option epaisseur" role="button" tabindex="0" :class="{'actif': epaisseurStylo === 10}" @click="modifierEpaisseur(10)" @keydown.enter="modifierEpaisseur(10)" v-if="outilDessiner">
				<span>10</span>
			</span>
			<span class="option epaisseur" role="button" tabindex="0" :class="{'actif': epaisseurStylo === 20}" @click="modifierEpaisseur(20)" @keydown.enter="modifierEpaisseur(20)" v-if="outilDessiner">
				<span>20</span>
			</span>
			<span class="option epaisseur" role="button" tabindex="0" :class="{'actif': epaisseurStylo === 40}" @click="modifierEpaisseur(40)" @keydown.enter="modifierEpaisseur(40)" v-if="outilDessiner">
				<span>40</span>
			</span>
			<span class="option epaisseur" role="button" tabindex="0" :class="{'actif': epaisseurStylo === 80}" @click="modifierEpaisseur(80)" @keydown.enter="modifierEpaisseur(80)" v-if="outilDessiner">
				<span>80</span>
			</span>
			<span class="option label-transparence" v-if="outilDessiner">
				<span><i class="material-icons">opacity</i></span>
			</span>
			<span class="option transparence" role="button" tabindex="0" :class="{'actif': transparenceStylo === 0.4}" v-if="outilDessiner" @click="modifierTransparence(0.4)" @keydown.enter="modifierTransparence(0.4)">
				<span>0.4</span>
			</span>
			<span class="option transparence" role="button" tabindex="0" :class="{'actif': transparenceStylo === 0.6}" v-if="outilDessiner" @click="modifierTransparence(0.6)" @keydown.enter="modifierTransparence(0.6)">
				<span>0.6</span>
			</span>
			<span class="option transparence" role="button" tabindex="0" :class="{'actif': transparenceStylo === 1}" v-if="outilDessiner" @click="modifierTransparence(1)" @keydown.enter="modifierTransparence(1)">
				<span>1</span>
			</span>
			...
			<span class="option icone" role="button" tabindex="0" :title="$t('reduireTransparence')" v-if="outilSelectionner && nom !== 'selection' && (objet === 'rectangle-plein' || objet === 'cercle-plein')" @click="reduireTransparence" @keydown.enter="reduireTransparence">
				<span><i class="material-icons">remove</i></span>
			</span>
			<span class="option icone" role="button" tabindex="0" :title="$t('augmenterTransparence')" v-if="outilSelectionner && nom !== 'selection' && (objet === 'rectangle-plein' || objet === 'cercle-plein')" @click="augmenterTransparence" @keydown.enter="augmenterTransparence">
			...
			<span class="option icone" role="button" tabindex="0" :title="$t('reduireTaille')" v-if="outilSelectionner && nom !== 'selection' && objet === 'texte'" @click="reduireTailleTexte" @keydown.enter="reduireTailleTexte">
				<span><i class="material-icons">remove</i></span>
			</span>
			<span class="option icone" role="button" tabindex="0" :title="$t('augmenterTaille')" v-if="outilSelectionner && nom !== 'selection' && objet === 'texte'" @click="augmenterTailleTexte" @keydown.enter="augmenterTailleTexte">
				<span><i class="material-icons">add</i></span>
			</span>
			<span class="separateur" v-if="(outilSelectionner && nom !== 'selection' && (objet === 'texte' || objet === 'rectangle-plein' || objet === 'cercle-plein'))" />
			<span class="option icone" role="button" tabindex="0" :title="$t('dupliquer')" v-if="outilSelectionner && nom !== 'selection'" @click="dupliquer" @keydown.enter="dupliquer">
				<span><i class="material-icons">content_copy</i></span>
			</span>
			<span class="option icone rouge" role="button" tabindex="0" :title="$t('supprimer')" v-if="outilSelectionner && nom !== 'selection'" @click="supprimer" @keydown.enter="supprimer">
				<span><i class="material-icons">delete</i></span>
			</span>
			<span class="option icone rouge" role="button" tabindex="0" :title="$t('supprimer')" v-else-if="outilSelectionner && nom === 'selection'" @click="supprimerSelection" @keydown.enter="supprimerSelection">
				<span><i class="material-icons">delete</i></span>
			</span>
		</div>
			...
			<div class="modale" role="dialog">
				<div class="conteneur">
					<div class="contenu">
						...
						<div class="actions">
							<span class="bouton" role="button" tabindex="0" @click="fermerModale" @keydown.enter="fermerModale">{{ $t('annuler') }}</span>
							<span class="bouton" role="button" tabindex="0" @click="ajouterTexte" @keydown.enter="ajouterTexte" v-if="outil === 'texte' || outil === 'label'">{{ $t('valider') }}</span>
							<span class="bouton" role="button" tabindex="0" @click="enregistrerTexte" @keydown.enter="enregistrerTexte" v-else>{{ $t('valider') }}</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modale" role="dialog">
				<div class="conteneur">
					<div class="contenu">
						...
						<div class="actions">
							<span class="bouton" role="button" tabindex="0" @click="confirmation = false" @keydown.enter="confirmation = false">{{ $t('annuler') }}</span>
							<span class="bouton" role="button" tabindex="0" @click="reinitialiser" @keydown.enter="reinitialiser">{{ $t('valider') }}</span>
						</div>
					</div>
				</div>
			</div>
...
export default {
	...
	mounted () {
		...
		this.dimensionsCanva.w = rect.width
		this.dimensionsCanva.h = rect.height
		document.addEventListener('keydown', this.gererClavierAnnotation, false)
	},
	beforeUnmount () {
		...
		document.removeEventListener('keydown', this.gererClavierAnnotation, false)
	},
	methods: {
		...
		gererClavierAnnotation (event) {
			if (event.key === 'Escape' && this.modale === 'texte') {
				this.fermerModale()
			} else if (event.ctrlKey && event.key === 'd' && this.modale !== 'texte') {
				event.preventDefault()
				this.dupliquer()
			} else if ((event.key === 'Backspace' || event.key === 'Delete' || event.key === 'Escape') && this.modale !== 'texte') {
...
#options .option.icone input[type="color"]:focus::-moz-color-swatch {
...
#options .option.icone input[type="color"]:focus::-webkit-color-swatch {
	border: 1px solid #001d1d;
}
