	...
	<JsPanel class="panneau" :visible="!chargement" :options="options">
		...
		<div class="conteneur panneau-tableau">
			<div class="contenu edition" v-if="mode === 'edition'">
				<label :for="'lignes_' + id">{{ $t('lignes') }}</label>
				<input :id="'lignes_' + id" type="number" class="lignes" :value="lignes" :min="1" :max="100" @input="lignes = $event.target.value">
				...
				<div class="boutons">
					<span class="bouton-secondaire" role="button" tabindex="0" :title="$t('supprimerColonne')" @click="supprimerColonne" @keydown.enter="supprimerColonne" v-if="colonnes.length > 1"><i class="material-icons">remove_circle_outline</i></span>
					<span class="bouton-secondaire" role="button" tabindex="0" :title="$t('ajouterColonne')" @click="ajouterColonne" @keydown.enter="ajouterColonne"><i class="material-icons">add_circle_outline</i></span>
				</div>
				<div class="actions">
			...
			<div class="contenu" v-else>
				...
				<div class="boutons">
					<span class="bouton-secondaire" role="button" tabindex="0" :title="$t('supprimerLigne')" @click="supprimerLigne" @keydown.enter="supprimerLigne" v-if="tableau.length > 1"><i class="material-icons">remove_circle_outline</i></span>
					<span class="bouton-secondaire" role="button" tabindex="0" :title="$t('ajouterLigne')" @click="ajouterLigne" @keydown.enter="ajouterLigne"><i class="material-icons">add_circle_outline</i></span>
				</div>
			</div>
		</div>
