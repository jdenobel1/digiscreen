		...
		<div class="conteneur panneau-dessin">
			<div class="contenu">
				...
				<div class="outils-dessin">
					<span class="outil noir" role="button" tabindex="0" :class="{'actif': couleurStylo === '#000000'}" :title="$t('noir')" @click="modifierCouleur('#000000')" @keydown.enter="modifierCouleur('#000000')">
						<span class="couleur noir" />
					</span>
					<span class="outil blanc" role="button" tabindex="0" :class="{'actif': couleurStylo === '#ffffff'}" :title="$t('blanc')" @click="modifierCouleur('#ffffff')" @keydown.enter="modifierCouleur('#ffffff')">
						<span class="couleur blanc" />
					</span>
					<span class="outil rouge" role="button" tabindex="0" :class="{'actif': couleurStylo === '#ff0000'}" :title="$t('rouge')" @click="modifierCouleur('#ff0000')" @keydown.enter="modifierCouleur('#ff0000')">
						<span class="couleur rouge" />
					</span>
					<span class="outil jaune" role="button" tabindex="0" :class="{'actif': couleurStylo === '#ffff00'}" :title="$t('jaune')" @click="modifierCouleur('#ffff00')" @keydown.enter="modifierCouleur('#ffff00')">
						<span class="couleur jaune" />
					</span>
					<span class="outil vert" role="button" tabindex="0" :class="{'actif': couleurStylo === '#00ff00'}" :title="$t('vert')" @click="modifierCouleur('#00ff00')" @keydown.enter="modifierCouleur('#00ff00')">
						<span class="couleur vert" />
					</span>
					<span class="outil bleu" role="button" tabindex="0" :class="{'actif': couleurStylo === '#04fdff'}" :title="$t('bleu')" @click="modifierCouleur('#04fdff')" @keydown.enter="modifierCouleur('#04fdff')">
						<span class="couleur bleu" />
					</span>
					<span class="separateur" />
					<span class="outil" role="button" tabindex="0" :title="$t('reinitialiser')" @click="reinitialiser" @keydown.enter="reinitialiser">
...
export default {
	...
	mounted () {
		...
		if (this.statut !== 'min') {
			setTimeout(function () {
				document.querySelector('#' + this.id + ' .outil').focus()
			}.bind(this), 0)
		}
	},
	methods: {
