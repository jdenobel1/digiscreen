<template>
	<JsPanel class="panneau" :visible="!chargement" :options="options">
		...
		<div class="conteneur panneau-modalites">
			<div class="contenu">
				<div class="modalites">
					<span role="button" tabindex="0" @click="modalite = 'silence'" @keydown.enter="modalite = 'silence'" style="background-image: url('./static/img/modalites/silence.png')" />
					<span role="button" tabindex="0" @click="modalite = 'ecoutez'" @keydown.enter="modalite = 'ecoutez'" style="background-image: url('./static/img/modalites/ecoutez.png')" />
					<span role="button" tabindex="0" @click="modalite = 'chuchotez'" @keydown.enter="modalite = 'chuchotez'" style="background-image: url('./static/img/modalites/chuchotez.png')" />
					<span role="button" tabindex="0" @click="modalite = 'parlez'" @keydown.enter="modalite = 'parlez'" style="background-image: url('./static/img/modalites/parlez.png')" />
					<span role="button" tabindex="0" @click="modalite = 'communiquez'" @keydown.enter="modalite = 'communiquez'" style="background-image: url('./static/img/modalites/communiquez.png')" />
				</div>
				<div class="modalite">
...
export default {
	...
	mounted () {
		...
		if (this.statut !== 'min') {
			setTimeout(function () {
				document.querySelector('#' + this.id + ' span[role="button"]').focus()
			}.bind(this), 0)
		}
	}
}
